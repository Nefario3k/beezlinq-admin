<template>
  <div class="search__area">
    ...
    <aside class="actions__area">
      ...
      <!-- grid control  -->
      <Button
        @click="$emit('setGridLayout', 12)"
        title="Displays table in row format"
        :elevation="0"
        :svg="true"
        svgLeft="SvgAlignRow"
        :outlined="true"
        :contentClass="`logBtn ${currentView === 12 ? 'active' : ''}`"
        width="3.6rem"
        minWidth="3.6rem"
        height="3.6rem"
        color="var(--border4)"
      />
      <Button
        @click="$emit('setGridLayout', 6)"
        title="Displays table in column format"
        :elevation="0"
        :svg="true"
        svgLeft="SvgAlignColumn"
        :outlined="true"
        :contentClass="`logBtn ${currentView === 6 ? 'active' : ''}`"
        width="3.6rem"
        minWidth="3.6rem"
        height="3.6rem"
        color="var(--border4)"
