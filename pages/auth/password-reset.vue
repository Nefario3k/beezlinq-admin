      ...
      <div class="col col-12">
        <div class="auth_content">
          ...
          >
            ...
            <v-tabs-items v-model="tabIndicator" class="m-0 p-0">
              <!-- verify email  -->
              <v-tab-item class="p-0 px-1 m-0">
                <form class="row" @submit.prevent="tabIndicator = 1">
                  <!-- header  -->
                  <header class="col-12">
              ...
              <!-- enter token  -->
              <v-tab-item class="p-0 px-1 m-0">
                <form class="row" @submit.prevent="tabIndicator = 2">
                  <!-- header  -->
                  <header class="col-12">
              ...
              <!-- new password  -->
              <v-tab-item class="p-0 px-1 m-0">
                <form class="row" @submit.prevent="tabIndicator = 0">
                  <!-- header  -->
                  <header class="col-12">
